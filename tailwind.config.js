...
const config = {
	darkMode: ['class'],
	content: [
		'./src/**/*.{html,js,svelte,ts}', // Archivos de tu proyecto
		'./node_modules/svelte-ux/**/*.{svelte,js}', // Archivos de svelte-ux necesarios para layerchart
		'./node_modules/layerchart/**/*.{svelte,js}' // Archivos de layerchart
	],
	safelist: ['dark'],
	theme: {
		container: {
		...
		extend: {
			colors: {
				...
				quaternary: {
					DEFAULT: 'hsl(var(--quaternary) / <alpha-value>)'
				},
				quinary: {
					DEFAULT: 'hsl(var(--quinary) / <alpha-value>)'
				},
				destructive: {
